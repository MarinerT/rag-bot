...
class Application(param.Parameterized):
    api_key_input = pn.widgets.PasswordInput(name='API Key', placeholder='Enter your API key here')
    ...
    def submit_api_key(self, event):
        ...
        if api_key:
            ...
            print("""add the folders resume and docs/chroma to gitignore if it exists
                or it creates a .gitignore if it doesn't exist in this directory.""")
            ...
            dashboard = initialize_api_dependent_components(api_key, pdf_doc)  # This should return the dashboard component
            ...
            acknowledgment_area.object = "API key successfully added to .env file."
        else:
